...
post-processed by drilling/reaming critical holes to final size. The figures below summarize key
...
\begin{figure}[H]
    ...
    backlash was minimized through post-processing of bores and the use of press-fit pins with
