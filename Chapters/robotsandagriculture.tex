...
\begin{figure}
    ...
    \caption{Internal view of a UR5 robotic arm on the linear rail used to scan apple trees \cite{robotApple}}
...
\begin{figure}
    ...
    \caption{Grasping states of long column strip objects: (a) cherry, (b) loquat, (c) zucchini \cite{multipurpuse_gripper}}
    \label{fig:gripper_shapes}
\end{figure}
...
\section{Comprehensive Analysis: Rationale for Robotics in Asparagus Farming}
...
\begin{figure}
    ...
    \caption{Manual process of picking spears from the field}
    \label{fig:manual_pick}
\end{figure}
	

labor shortages, exacerbated by aging rural populations and urban migration (e.g., China’s rural workforce over 60 exceeds 23 per recent census trends), strain production capacity, prompting a push for agricultural mechanization alternatives, outlined in Table~\ref{tab:benefits} \cite{mccluskey2007economics}
...
\begin{table}[h]
    ...
    \begin{tabular}{|l|p{6cm}|p{5cm}|}
        ...
        \hline
    \end{tabular}
    \caption{Importance and benefits of automation aspects}
    \label{tab:benefits}
\end{table}
...
\begin{figure}
    ...
    \caption{Sprout from Muddy Machines}
    \label{fig:muddy_sprout}
\end{figure}
...
\begin{figure}
    ...
    \caption{Robot from Inaho working in a greenhouse environment}
    \label{fig:inaho}
\end{figure}
